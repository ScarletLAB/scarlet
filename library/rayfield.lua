...
local RayfieldLibrary = {
	...
	Theme = {
		Default = {
			...
			ToggleDisabledStroke = Color3.fromRGB(150, 110, 110),
		...
		Minty = {
			...
			TabBackground = Color3.fromRGB(71, 70, 86),
			TabStroke = Color3.fromRGB(81, 75, 96),
			...
			SliderStroke = Color3.fromRGB(83, 158, 132),
