...
local RayfieldLibrary = {
	...
	Theme = {
		Default = {
			...
			Topbar = Color3.fromRGB(49, 19, 19),
			Shadow = Color3.fromRGB(35, 5, 5),
		
			NotificationBackground = Color3.fromRGB(35, 5, 5),
			NotificationActionsBackground = Color3.fromRGB(235, 215, 215),
		
			TabBackground = Color3.fromRGB(95, 65, 65),
			TabStroke = Color3.fromRGB(100, 70, 70), 
			TabBackgroundSelected = Color3.fromRGB(225, 195, 195),
			TabTextColor = Color3.fromRGB(240, 225, 225),
			SelectedTabTextColor = Color3.fromRGB(65, 35, 35),
		
			ElementBackground = Color3.fromRGB(50, 20, 20),
			ElementBackgroundHover = Color3.fromRGB(55, 25, 25),
			SecondaryElementBackground = Color3.fromRGB(40, 10, 10),
			ElementStroke = Color3.fromRGB(65, 35, 35),
			SecondaryElementStroke = Color3.fromRGB(55, 25, 25),
		
			SliderBackground = Color3.fromRGB(124, 39, 50),
			SliderProgress = Color3.fromRGB(215, 67, 86), 
			SliderStroke = Color3.fromRGB(124, 39, 50),
		
			ToggleBackground = Color3.fromRGB(45, 15, 15),
			ToggleEnabled = Color3.fromRGB(215, 67, 86),
			ToggleDisabled = Color3.fromRGB(115, 85, 85),
			ToggleEnabledStroke = Color3.fromRGB(124, 39, 50),
			ToggleDisabledStroke = Color3.fromRGB(80, 50, 50),
			ToggleEnabledOuterStroke = Color3.fromRGB(124, 39, 50),
			ToggleDisabledOuterStroke = Color3.fromRGB(80, 50, 50),
		
			DropdownSelected = Color3.fromRGB(55, 25, 25),
			DropdownUnselected = Color3.fromRGB(45, 15, 15),
		
			InputBackground = Color3.fromRGB(45, 15, 15), 
			InputStroke = Color3.fromRGB(80, 50, 50),
			PlaceholderColor = Color3.fromRGB(193, 163, 163)
		},
		...
		Minty = {
			...
			TabStroke = Color3.fromRGB(71, 70, 86),
			TabBackgroundSelected = Color3.fromRGB(111, 206, 174),
	...
	Gamesense = {
		...
		Topbar = Color3.fromRGB(37, 37, 52),
		Shadow = Color3.fromRGB(24, 24, 36),

		NotificationBackground = Color3.fromRGB(30, 30, 42),
		NotificationActionsBackground = Color3.fromRGB(42, 42, 58),

		TabBackground = Color3.fromRGB(50, 50, 64),
		TabStroke = Color3.fromRGB(42, 42, 58),
		TabBackgroundSelected = Color3.fromRGB(80, 234, 4),
		TabTextColor = Color3.fromRGB(179, 179, 179),
		SelectedTabTextColor = Color3.fromRGB(30, 30, 42),

		ElementBackground = Color3.fromRGB(42, 42, 58),
		ElementBackgroundHover = Color3.fromRGB(48, 48, 74),
		SecondaryElementBackground = Color3.fromRGB(37, 37, 52),
		ElementStroke = Color3.fromRGB(50, 50, 64),
		SecondaryElementStroke = Color3.fromRGB(42, 42, 58),

		SliderBackground = Color3.fromRGB(37, 37, 52),
		SliderProgress = Color3.fromRGB(80, 234, 4),
		SliderStroke = Color3.fromRGB(50, 50, 64),

		ToggleBackground = Color3.fromRGB(37, 37, 52),
		ToggleEnabled = Color3.fromRGB(80, 234, 4),
		ToggleDisabled = Color3.fromRGB(50, 50, 64),
		ToggleEnabledStroke = Color3.fromRGB(80, 234, 4),
		ToggleDisabledStroke = Color3.fromRGB(50, 50, 64),
		ToggleEnabledOuterStroke = Color3.fromRGB(37, 37, 52),
		ToggleDisabledOuterStroke = Color3.fromRGB(30, 30, 42),

		DropdownSelected = Color3.fromRGB(42, 42, 58),
		DropdownUnselected = Color3.fromRGB(37, 37, 52),

		InputBackground = Color3.fromRGB(37, 37, 52),
		InputStroke = Color3.fromRGB(50, 50, 64),
		PlaceholderColor = Color3.fromRGB(179, 179, 179)
	},
